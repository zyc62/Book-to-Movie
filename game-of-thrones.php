...
<head>
        ...
        <meta charset="utf-8">
        <link rel = "stylesheet" title = "basic style" type = "text/css" href = "./game-of-thrones.css" media = "all">
</head>
...
login;
    ...
    <div class = "top">
     ...
     $moviename = $_GET["id"];
     $table = 'movieinfo';
     $sql = "SELECT image,video,introduction from $table WHERE name = \"$moviename\"";
     if(mysqli_query($connect,$sql)){
     $array=mysqli_query($connect, $sql);
     while($row=mysqli_fetch_array($array))
     {

      echo "<img src = '".$row[0]."' height = '300' alt = '".$row[0]."'>";
      echo "<p class = 'book_introduction'>".$row[2]."</p >";
      echo "<div class = 'buy'><a href = '".$row[3]."'> Buy on Amazon</a ></div>";
      echo "</div>";
...
<div class = "middle">
 ...
 &#9650;
    ...
    <div class = "related">
      ...
      <img src = "./game-of-thrones/sherlock.jpg" alt = "sherlock" width = "256" height = "144"><br><br>
      <img src = "./game-of-thrones/Handmaids_Tale.jpg" alt = "handmaid's tale"  width = "256" height = "144">
   </div>
